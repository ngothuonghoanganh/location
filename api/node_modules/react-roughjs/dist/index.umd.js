(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('d3-shape'), require('shallowequal'), require('roughjs/dist/rough.umd')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'd3-shape', 'shallowequal', 'roughjs/dist/rough.umd'], factory) :
  (global = global || self, factory(global.reactRoughjs = {}, global.react, global.d3Shape, global.shallowequal, global.roughjs));
}(this, (function (exports, React, d3Shape, shallowEqual, roughjs) {
  shallowEqual = shallowEqual && shallowEqual.hasOwnProperty('default') ? shallowEqual['default'] : shallowEqual;
  roughjs = roughjs && roughjs.hasOwnProperty('default') ? roughjs['default'] : roughjs;
  ...
  function useDrawEffect(drawFnName, deps, props) {
    ...
    var fakeNodeRef = React.useRef(null);
  ...
  var RoughProvider = function RoughProvider(props) {
    ...
    return React.createElement(Provider, {
      value: value
    }, React.createElement("g", Object.assign({}, rest, {
      ref: ref
    })));
  };
  ...
  exports.RoughProvider = RoughProvider;
