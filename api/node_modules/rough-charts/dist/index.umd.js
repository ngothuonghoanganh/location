(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-roughjs'), require('d3-scale'), require('d3-shape'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-roughjs', 'd3-scale', 'd3-shape', 'react-dom'], factory) :
  (global = global || self, factory(global.roughCharts = {}, global.react, global.reactRoughjs, global.d3Scale, global.d3Shape, global.ReactDOM));
}(this, (function (exports, React, reactRoughjs, d3Scale, d3Shape, ReactDOM) {
  function _extends() {
  ...
  function useChartContext(props, scaleKeyName) {
    var value = React.useContext(ChartContext);
    ...
    React.useEffect(function () {
      ...
      if (scaleKeyName === 'barDataKeys') {
        setScaleData(function (prev) {
          ...
          var barScale = d3Scale.scaleBand().domain(newScaleData[scaleKeyName]);
  ...
  var XAxis = function XAxis(props) {
    ...
    var y = contentHeight;
    return React.createElement(React.Fragment, null, React.createElement(reactRoughjs.Line, {
      x1: 0,
      y1: y,
      ...
      return React.createElement(React.Fragment, {
        key: index
      }, React.createElement(reactRoughjs.Line, {
  ...
  var BarSeries = function BarSeries(props) {
    ...
    return React.createElement(React.Fragment, null, data.map(function (item, index) {
      ...
      return isFunction(children) ? processTooltipHandlers(children(item, childProps, index), handlers) : React.createElement(reactRoughjs.Rectangle, Object.assign({
        key: index
      }, childProps, handlers));
    }));
  };
  ...
  var Arc = function Arc(props) {
    ...
    return React.createElement(reactRoughjs.Path, Object.assign({
      d: d,
  ...
  var ArcSeries = function ArcSeries(props) {
    ...
    var arcs = d3Shape.pie().startAngle(startAngleProp).padAngle(padAngleProp).endAngle(endAngleProp)(data.map(function (d) {
      return d[dataKey];
    }));
    ...
    return React.createElement(React.Fragment, null, arcsData.map(function (arcProps, index) {
      var item = data[index];
      ...
      return React.createElement(Arc, Object.assign({
        key: index
      }, childProps, handlers));
    }));
  };
  ...
  var Y0 = function Y0(props) {
    ...
    return React.createElement(reactRoughjs.Line, {
      y1: yScale(0),
      y2: yScale(0),
      x1: 0,
      x2: contentWidth,
  ...
  var CircleSeries = function CircleSeries(props) {
    ...
    var children = props.children;
    return React.createElement(React.Fragment, null, points.map(function (_ref, index) {
      var x = _ref[0],
          y = _ref[1];
      var childProps = {
        x: x + bandwidth / 2,
      ...
      return React.createElement(reactRoughjs.Circle, Object.assign({
        key: index
      }, childProps, handlers));
    }));
  };
  ...
  var LineSeries = function LineSeries(props) {
    ...
    var line = d3Shape.line().curve(curve);
    var path = line(points);
    return React.createElement(React.Fragment, null, React.createElement(reactRoughjs.Path, {
      transform: "translate(" + bandwidth / 2 + ", 0)",
      d: path,
      options: options
    }), React.createElement(CircleSeries, Object.assign({}, props)));
  };
  ...
  var Tooltip = function Tooltip(props) {
    ...
    var _React$useState = React.useState(120),
    ...
    }, React.createElement(reactRoughjs.RoughProvider, null, React.createElement(reactRoughjs.Rectangle, {
      width: width,
      height: height,
      onMouseOver: function onMouseOver(e) {
        setTooltipData(function (prev) {
    ...
    })), React.createElement(reactRoughjs.RoughProvider, null, renderChildren()))));
  ...
  var ChartProvider = function ChartProvider(props) {
    ...
    var internalXScale = d3Scale.scaleBand();
    var internalYScale = d3Scale.scaleLinear();
    ...
    }, React.createElement(reactRoughjs.RoughProvider, {
  ...
  Object.defineProperty(exports, 'Circle', {
    enumerable: true,
    get: function () {
      return reactRoughjs.Circle;
    }
  });
  Object.defineProperty(exports, 'Rectangle', {
    enumerable: true,
    get: function () {
      return reactRoughjs.Rectangle;
    }
  });
  exports.Arc = Arc;
  exports.ArcSeries = ArcSeries;
