...
export declare type DataKey = 'xDataKey' | 'yDataKey' | 'barDataKeys' | 'lineDataKeys' | 'circleDataKeys' | 'areaDataKeys';
...
export declare type ScaleType = 'scaleLinear' | 'scaleBand';
...
export declare const ChartContext: React.Context<ChartContextReturn<any>>;
